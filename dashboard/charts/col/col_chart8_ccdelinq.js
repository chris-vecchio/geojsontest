var chartData = {
    ...
    series: [
    {
        ...
        legendIndex: 0,
        name: 'Columbus',
        dataname: 'colccdelinq',
        legendname: 'Columbus',
        tooltipname: 'Columbus',
        marker: {
            enabled: false
        },
        data: [[Date.UTC(2008,2,1),6.93],[Date.UTC(2008,5,1),6.99],[Date.UTC(2008,8,1),6.91],[Date.UTC(2008,11,1),6.90],[Date.UTC(2009,2,1),7.00],[Date.UTC(2009,5,1),7.12],[Date.UTC(2009,8,1),7.48],[Date.UTC(2009,11,1),7.71],[Date.UTC(2010,2,1),7.97],[Date.UTC(2010,5,1),8.18],[Date.UTC(2010,8,1),8.17],[Date.UTC(2010,11,1),8.16],[Date.UTC(2011,2,1),7.99],[Date.UTC(2011,5,1),7.65],[Date.UTC(2011,8,1),7.29],[Date.UTC(2011,11,1),6.90],[Date.UTC(2012,2,1),6.52],[Date.UTC(2012,5,1),6.29],[Date.UTC(2012,8,1),6.14],[Date.UTC(2012,11,1),6.52],[Date.UTC(2013,2,1),7.01],[Date.UTC(2013,5,1),7.46],[Date.UTC(2013,8,1),7.92],[Date.UTC(2013,11,1),7.89],[Date.UTC(2014,2,1),7.67],[Date.UTC(2014,5,1),7.34],[Date.UTC(2014,8,1),7.05],[Date.UTC(2014,11,1),6.70],[Date.UTC(2015,2,1),6.65],[Date.UTC(2015,5,1),6.64],[Date.UTC(2015,8,1),6.63],[Date.UTC(2015,11,1),6.58],[Date.UTC(2016,2,1),6.55],[Date.UTC(2016,5,1),6.54],[Date.UTC(2016,8,1),6.48],[Date.UTC(2016,11,1),6.45],[Date.UTC(2017,2,1),6.34],[Date.UTC(2017,5,1),6.28],[Date.UTC(2017,8,1),6.33],[Date.UTC(2017,11,1),6.39],[Date.UTC(2018,2,1),6.44]]
    },{
        index: 1,
        zIndex: 1,
        legendIndex: 1,
