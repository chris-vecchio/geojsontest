var chartData = {
    ...
    series: [
    {
        ...
        legendIndex: 0,
        name: 'Cleveland',
        dataname: 'cvlccdelinq',
        legendname: 'Cleveland',
        tooltipname: 'Cleveland',
        marker: {
            enabled: false
        },
        data: [[Date.UTC(2008,2,1),9.07],[Date.UTC(2008,5,1),9.18],[Date.UTC(2008,8,1),8.96],[Date.UTC(2008,11,1),8.90],[Date.UTC(2009,2,1),8.99],[Date.UTC(2009,5,1),9.04],[Date.UTC(2009,8,1),9.41],[Date.UTC(2009,11,1),9.73],[Date.UTC(2010,2,1),9.92],[Date.UTC(2010,5,1),10.07],[Date.UTC(2010,8,1),10.07],[Date.UTC(2010,11,1),10.09],[Date.UTC(2011,2,1),10.04],[Date.UTC(2011,5,1),9.78],[Date.UTC(2011,8,1),9.34],[Date.UTC(2011,11,1),8.84],[Date.UTC(2012,2,1),8.38],[Date.UTC(2012,5,1),8.07],[Date.UTC(2012,8,1),8.08],[Date.UTC(2012,11,1),8.43],[Date.UTC(2013,2,1),8.72],[Date.UTC(2013,5,1),8.99],[Date.UTC(2013,8,1),9.09],[Date.UTC(2013,11,1),8.81],[Date.UTC(2014,2,1),8.40],[Date.UTC(2014,5,1),7.98],[Date.UTC(2014,8,1),7.64],[Date.UTC(2014,11,1),7.27],[Date.UTC(2015,2,1),7.30],[Date.UTC(2015,5,1),7.40],[Date.UTC(2015,8,1),7.49],[Date.UTC(2015,11,1),7.53],[Date.UTC(2016,2,1),7.49],[Date.UTC(2016,5,1),7.41],[Date.UTC(2016,8,1),7.40],[Date.UTC(2016,11,1),7.46],[Date.UTC(2017,2,1),7.45],[Date.UTC(2017,5,1),7.50],[Date.UTC(2017,8,1),7.52],[Date.UTC(2017,11,1),7.53],[Date.UTC(2018,2,1),7.61]]
    },{
        index: 1,
        zIndex: 1,
        legendIndex: 1,
